      ...
      <v-row style="margin-top: -30px">
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8"
            >Tên khách sạn <span class="red--text">*</span>
          </v-card-text>
        </v-col>
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8"
            >Phòng nghỉ <span class="red--text">*</span>
          </v-card-text>
        </v-col>
        <v-col cols="9" class="pb-0">
          <v-autocomplete
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8">Giá</v-card-text>
        </v-col>
        <v-col cols="9" class="pl-0 pb-0 pt-1">
        ...
        <v-col cols="2" class="pr-0">
          <v-card-text class="pr-0 pb-0 pt-2 pl-8"
            >Thời gian đặt phòng <span class="red--text">*</span>
          </v-card-text>
        </v-col>
        <v-col cols="9" class="pt-0">
          <v-row>
            <v-col cols="3" class="pb-0 pl-0 d-flex">
              <div class="pl-3 pt-2 pr-3">Từ</div>
              <v-menu
                ref="menuStart"
                v-model="menuStart"
            ...
            <v-col cols="3" class="pb-0 pl-0 d-flex">
              <div class="pl-3 pt-2 pr-3">Đến</div>
              <v-menu
                ref="menuEnd"
                v-model="menuEnd"
                :close-on-content-click="false"
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8"
            >Số lượng phòng <span class="red--text">*</span>
          </v-card-text>
        </v-col>
        <v-col cols="9">
          <div
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8">Tổng số</v-card-text>
        </v-col>
        <v-col cols="9" class="pl-0 pb-0 pt-1">
          <v-card-text class="font-weight-bold"
            >{{
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pt-2 pl-8">Đơn vị thanh toán</v-card-text>
        </v-col>
        <v-col cols="9" class="pb-0">
          <v-select
            v-model="currency"
        ...
        <v-col cols="2">
          <v-card-text class="pb-0 pl-8">Thanh toán</v-card-text>
        </v-col>
        <v-col cols="9" class="pb-0 pl-0">
          <v-card-text
        ...
        <v-col cols="2" class="pr-0">
          <v-card-text class="pr-0 pt-2 pb-0 pl-8"
        ...
        <v-col cols="9" class="pb-0">
          <v-autocomplete
            ...
            dense
            flat
            :outlined="paymentError.length !== 0"
  ...
  methods: {
    ...
    Add() {
      ...
      this.$store
        ...
        .then((response) => {
          if (!response.error) {
            this.$showSuccess(this, 'Thêm giao dịch đặt phòng thành công')
            this.$emit('exit')
          }
        })
        .catch((e) => {
