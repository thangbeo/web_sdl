            ...
            <v-row>
              ...
              <v-col cols="8" style="text-align: right">
                <v-card-text class="pt-0"
                  >Khách sạn Mường Thanh Hà Nội</v-card-text
                >
                <v-card-text class="pt-0"
                  >12 - Nguyễn Xiển - Thanh Xuân - Hà Nội</v-card-text
                >
                <v-card-text class="pt-0">14:00 - T6, 05/05/2020</v-card-text>
                <v-card-text class="pt-0">12:00 - T2, 15/05/2020</v-card-text>
                <v-card-text class="pt-0">10 đêm, 2 phòng, 6 khách</v-card-text>
              </v-col>
            </v-row>
            <v-row class="px-4">
          ...
          <v-col cols="4" style="background-color: #fff">
            ...
            <v-row>
              <v-col cols="12" class="py-0 ml-4">
                <div class="fs-17 font-weight-bold mb-2">Muong Thanh Hotel</div>
            ...
            <v-row>
              ...
              <v-col cols="7" class="pr-7 pl-0" style="text-align: right">
                <v-card-text class="pt-0 px-0">80 m2</v-card-text>
                <v-card-text class="pt-0 px-0">1 đơn</v-card-text>
                <v-card-text
                  class="pt-0 px-0"
                  style="border-bottom: 1px solid #ececec"
                  >3 khách/ phòng</v-card-text
                >
              </v-col>
            </v-row>
            ...
            <v-row>
              ...
              <v-col cols="5" class="pt-0" style="text-align: right">
                <v-card-text class="pt-0" style="color: #3f69b8"
                  >1,082,251 Vnđ</v-card-text
                >
                <v-card-text class="pt-0" style="color: #3f69b8"
                  >10 đêm</v-card-text
                >
                <v-card-text class="pt-0" style="color: #3f69b8"
                  >325,000 Vnđ</v-card-text
                >
                <v-card-text class="pt-0" style="color: #3f69b8"
